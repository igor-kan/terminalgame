# Contributing to terminalgame

Thank you for your interest in contributing to terminalgame! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/terminalgame.git
   cd terminalgame
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/terminalgame.git
   ```
...
By contributing to terminalgame, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
...
This project supports Docker for containerized development:
